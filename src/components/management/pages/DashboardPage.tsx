...
export default function DashboardPage({ currentMode, onNavigate }: DashboardPageProps = {}) {
  ...
  const cashFlow: any = data.cashFlow || { salesIn: 0, otherIn: 0, expenses: 0, purchases: 0, otherOut: 0, net: 0 }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card className="border-0 shadow-md rounded-2xl">
          ...
          <CardContent className="px-5 pb-4 space-y-2">
            <CashFlowRow
              label="Sales"
              amount={cashFlow.salesIn}
              icon={ArrowUpRight}
              color="text-emerald-600"
            />
            <CashFlowRow
              label="Other Income"
              amount={cashFlow.otherIn}
              icon={ArrowUpRight}
              color="text-emerald-600"
            />
            <CashFlowRow
            ...
            <CashFlowRow
              label="Purchases"
              amount={-cashFlow.purchases}
              icon={ArrowDownRight}
              color="text-rose-600"
            />
            <CashFlowRow
              label="Other Out"
              amount={-cashFlow.otherOut}
              icon={ArrowDownRight}
              color="text-rose-600"
            />
